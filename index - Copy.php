...
<div class="row"> 
  <div class="col-md-10"> 
    ...
    <div class="row"> 
      ...
      <div class="card">
  <img src="./images/17c0d5d74d0a032550238eb285a66540.jpg" class="card-img-top" alt="Card image cap">
  <div class="card-body">
...
<div class="col-md-4 mb-2">
<div class="card">
  <img src="./images/rare-beauty-foundation-review-space-nk.jpg" class="card-img-top" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Add to Cart</a>
...
<div class="col-md-4 mb-2">
<div class="card">
  <img src="./images/img6.jpeg" class="card-img-top" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Add to Cart</a>
...
<div class="col-md-4 mb-2">
<div class="card">
  <img src="./images/img4.jpeg" class="card-img-top" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Add to Cart</a>
...
<div class="col-md-4 mb-2">
<div class="card">
  <img src="./images/fenty-lipsticks.webp" class="card-img-top" alt="Card image cap">
  <div class="card-body">
    <h5 class="card-title">Card title</h5>
    <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
    <a href="#" class="btn btn-primary">Add to Cart</a>
